...
def save_manifest(manifest_path: Path, manifest: dict) -> None:
    ...
    manifest["base_url"] = f"https://raw.githubusercontent.com/{github_repo}/{github_ref}/plugins/ccdocs/skills/docs/references/"
...
def main():
    ...
    # Create docs directory at plugins/ccdocs/skills/docs/references (marketplace structure)
    repo_root = Path(__file__).parent.parent
    skill_dir = repo_root / 'plugins' / 'ccdocs' / 'skills' / 'docs'
